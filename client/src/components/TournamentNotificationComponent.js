...
import {deleteTeamNotification, deleteTournamentNotification} from "../api/notificationApi";
...
export const TournamentNotificationComponent=({notification})=>{
    ...
    const  Accept = async ()=>{
        ...
        await jointTournament(notification.tournamentId,notification.teamId).then(()=>deleteTournamentNotification(notification.id));
