...
function TournamentManagement() {
  ...
  useEffect(() => {
    if (tournament.id) {
      checkAndHandleNextRound(tournament.id).then((data) => {
        return getAllMatchesForTournament(tournament.id).then((data) =>
          setMatches(data)
        );
      });
    }
  ...
  return user.tournamentOwner ? (
    <div className="TeamBlock">
      <div className="avatarTeam">
        <div className="avatar">
          <img
            src={
              tournament.logo
                ? process.env.REACT_APP_API_URL + tournament.logo
                : defaultLogo
            }
          />
        </div>
      ...
      {logo || name ? (
        <div className="submitButton">Применить изменения</div>
      ) : (
        false
      )}
                      ...
                      <div>
                        ...
                        <div>
                          <p className="teammatesListUsername">
                            {item.name ? item.name : "defaultName"}
                          </p>{" "}
                        </div>
      ...
      <div className="tournamentGrid">
        ...
        <div className="generateButton" onClick={createMatches}>
